...
- **Execution Environment Notes:**
  - **PowerShell:** The `&&` operator for chaining commands is not supported in the user's PowerShell environment. Commands must be executed sequentially.
    - `❌ DON'T: cd my-project && npm install`
    - `✅ DO: First run 'cd my-project', then run 'npm install' in a subsequent step.`
